...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/msrest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4022&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/msrest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `msrest` can be installed with:

```
conda install msrest
```

It is possible to list all of the versions of `msrest` available on your platform with:
